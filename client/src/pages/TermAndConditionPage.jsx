...
const TermAndConditionPage = () => {
  return (
    <section className='companyPolicyMainContainer'>
        ...
        <p>Welcome to *Dubai Experience* manage by Travelvago Sdn Bhd! These terms of use (the “Terms”) outline the agreement between you and Dubai Experience Management by Travelvago Sdn Bhd (“Travelvago”) regarding the use of our website and associated mobile application (collectively referred to as the “Website”). Please carefully read and understand these Terms. By accessing and using our Website, you agree tobebound by these Terms.</p>
        <ul>
            <h3>Definitions</h3>
